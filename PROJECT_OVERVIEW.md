...
This is a complete real estate lead generation and automation platform built specifically for **Waisons Realty** serving Wayne County, Michigan. The system handles everything from lead capture to automated follow-ups, scoring, and analytics.
...
- **Location**: Wayne County cities bonus (+15 pts), Michigan (+5 pts)
...
const leadScore = {
  ...
  location: {
    'wayne-county-major': 15,
    'wayne-county-other': 12,
    'michigan': 5,
    'out-of-state': 3
  },
  contact: {
...
**Built with ❤️ for Waisons Realty - Professional real estate services in Wayne County since 2024.**