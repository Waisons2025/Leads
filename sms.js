...
async function sendFollowUpSMS(leadData, sequenceStep = 1) {
    ...
    const messages = {
        ...
        2: `${firstName}, did you see your home valuation report? Properties in your area are selling fast! Allen Park market is hot right now. Let's chat about your options: (313) 769-5353`,
        
        3: `Hi ${firstName}, final follow-up on your ${address} valuation. We're here when you're ready to explore selling options. Your Allen Park location has great potential! - Waisons Realty`,
        
        urgent: `🔥 ${firstName}, your property score is ${score}/100 - that's excellent! Allen Park homes like yours are in high demand. Let's talk ASAP: (313) 769-5353 - Waisons Realty`
    };
...
async function sendMarketUpdateSMS(leadData) {
    ...
    const marketUpdates = [
        `${firstName}, Allen Park home prices are up 8% this month! Your ${address} value may have increased. Want an updated analysis? Call (313) 769-5353 - Waisons Realty`,
        ...
        `${firstName}, Southeast Michigan inventory is low = higher prices for sellers! Your ${address} could benefit. Free consultation available: (313) 769-5353 - Waisons Realty`
    ];
...
async function sendAppointmentReminderSMS(leadData, appointmentTime) {
    ...
    const message = `Hi ${firstName}, reminder: Your Waisons Realty consultation is tomorrow at ${appointmentTime}. We're located at 7311 Park Ave, Allen Park. Questions? (313) 769-5353`;
